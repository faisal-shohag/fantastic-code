...
const ProblemNavBar = ({problemName}) => {
    ...
    return (
        ...
        <span className="text-zinc-700">|</span>
            ...
            <Link className={`flex gap-1 items-center hover:bg-slate-100 hover:dark:bg-zinc-700 px-2 py-1 rounded-md hover:shadow-xl ${pathNames['editorial'] === path && 'dark:bg-zinc-700 bg-zinc-50 font-gg-semi'}`} href={pathNames['editorial']}>
            ...
            <Link className={`flex gap-1 items-center hover:bg-slate-100 hover:dark:bg-zinc-700 px-2 py-1 rounded-md hover:shadow-xl ${pathNames['solutions'] === path && 'dark:bg-zinc-700 bg-zinc-50 font-gg-semi'}`} href={pathNames['solutions']}>
            <IoFlask className="text-purple-500"/> Solutions
            </Link>
            
            <span className="text-zinc-700">|</span>

            <Link className={`flex gap-1 items-center hover:bg-slate-100 hover:dark:bg-zinc-700 px-2 py-1 rounded-md hover:shadow-xl ${pathNames['submissions'] === path && 'dark:bg-zinc-700 bg-zinc-50 font-gg-semi'}`} href={pathNames['submissions']}>
